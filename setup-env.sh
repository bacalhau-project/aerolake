...
echo "2. Test the pipeline: bacalhau job run jobs/pipeline-manager-switch.yaml --template-vars pipeline_type=validated --force"
echo "3. Run the uploader: bacalhau job run jobs/databricks-uploader-job.yaml --force"
echo ""
